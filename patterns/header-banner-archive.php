...
?>
<!-- wp:cover {"dimRatio":60,"overlayColor":"contrast","minHeight":320,"minHeightUnit":"px","isDark":true,"align":"full","className":"cz-archive-banner","style":{"spacing":{"margin":{"top":"0","bottom":"0"},"padding":{"top":"var:preset|spacing|60","bottom":"var:preset|spacing|60"}}},"layout":{"type":"constrained"}} -->
<div class="wp-block-cover alignfull cz-archive-banner" style="margin-top:0;margin-bottom:0;padding-top:var(--wp--preset--spacing--60);padding-bottom:var(--wp--preset--spacing--60);min-height:320px">
